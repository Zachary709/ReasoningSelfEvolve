...
def compute_score(data_source: str, solution_str: str, ground_truth: Any, extra_info: Dict[str, Any] = None) -> float:
    """
    Compute score using Qwen2.5-Math evaluation logic.

    Args:
        data_source (str): The data source identifier (not used but required by interface)
        solution_str (str): The model's response/solution
        ground_truth (Any): The ground truth answer (typically a string)
        extra_info (Dict[str, Any], optional): Additional information (not used)
